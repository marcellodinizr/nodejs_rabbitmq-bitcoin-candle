...
var messageChannels_1 = require("./messages/messageChannels");
...
var generateCandles = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, messageChannels_1.createMessageChannel)()];
            case 1:
            ...
            case 2:
                ...
                loopTimes = Period_1.default.ONE_MINUTE / Period_1.default.TEN_SECONDS;
                candle = new Candle_1.default("BTC", new Date());
                console.log("--------------------------");
